...
5. Document runtime variables or provider toggles (OpenAI vs. OpenRouter) in `knowledge/05-openrouter-setup.md` / `knowledge/06-ollama-setup.md` before executing heavy jobs.
